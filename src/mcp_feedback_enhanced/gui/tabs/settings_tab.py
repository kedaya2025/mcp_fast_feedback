...
class SettingsTab(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        # === 語言設置 ===
        self._create_language_section(left_layout)

        # 添加分隔線
        self._add_separator(left_layout)

        # === 界面佈局 ===
        self._create_layout_section(left_layout)
        ...
        # === 視窗設置 ===
        self._create_window_section(right_layout)

        # 添加分隔線
        self._add_separator(right_layout)

        # === 超時設置 ===
        self._create_timeout_section(right_layout)

        # 添加分隔線
        self._add_separator(right_layout)

        # === 重置設定 ===
        self._create_reset_section(right_layout)
